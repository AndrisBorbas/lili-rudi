...
const SheetOverlay = ({
	...
	<SheetPrimitive.Overlay
		className={cn(
			"data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-neutral-800/40 duration-100 supports-backdrop-filter:backdrop-blur-xs",
			className,
		)}
		{...props}
		ref={ref}
